//
//  DetalleConcursosViewController
...
class DetalleConcursosViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "showDataQRACTIONCONCURSO"{
            let nav = segue.destinationViewController as! UINavigationController
            let QRConcursosVC = nav.topViewController as! QRConcursosViewController
            
            QRConcursosVC.qrData = detalleTipoOferta
            
        }
        
        
        if segue.identifier == "showBarcodeConcursoData"{
            let nav = segue.destinationViewController as! UINavigationController
            let CBConcursosVC = nav.topViewController as! CBConcursosViewController
            
            CBConcursosVC.codeBarData = detalleTipoOferta
